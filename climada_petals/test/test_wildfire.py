...
class TestWildFire(unittest.TestCase):
    ...
    def test_hist_fire_season_firms_pass(self):
        ...
        self.assertEqual(wf.intensity[0, :].nonzero()[1][100], 1668)
    ...
    def test_proba_fire_season_pass(self):
        ...
        self.assertAlmostEqual(round(wf.centroids.fire_propa_matrix[1,20],2), 0.83)
        self.assertAlmostEqual(round(wf.centroids.fire_propa_matrix[10,30],2), 0.70)
