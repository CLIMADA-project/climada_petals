...
class TestTCForecast(unittest.TestCase):
    ...
    def test_data_extraction_from_ecmwf(self):
        ...
        self.assertIsInstance(tr_forecast.data[0]['time_step'].values[0], np.int64)
        ...
        self.assertIsInstance(tr_forecast.data[0].ensemble_number, np.int64)
    ...
    def test_compute_TC_windfield_from_ecmwf(self):
        ...
        self.assertEqual(tc_forecast.tag.haz_type, 'TC')
