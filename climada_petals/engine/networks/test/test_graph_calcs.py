...
def test_check_access_with_rerouting_failed_source(graph_calcs_with_remote_node, dependency_table):
    """Test _check_access with rerouting enabled"""
...
def test_check_access_with_rerouting_via_disrupted(graph_calcs_with_remote_node, dependency_table):
...
def test_check_access_with_rerouting_new_source(graph_calcs_with_remote_node, dependency_table):
    """Test _check_access with rerouting when via is failing"""
    graph_calcs_with_remote_node.network_calc.network.initialize_funcstates()
    graph_calcs_with_remote_node.network_calc.network.initialize_capacity(dependency_table)
    graph_calcs_with_remote_node.network_calc.network.initialize_supply(dependency_table)
...
def test_check_access_without_rerouting_via_disrupted(graph_calcs_with_remote_node, dependency_table):
    """Test _check_access with rerouting when via is failing"""
    graph_calcs_with_remote_node.network_calc.network.initialize_funcstates()
    graph_calcs_with_remote_node.network_calc.network.initialize_capacity(dependency_table)
    graph_calcs_with_remote_node.network_calc.network.initialize_supply(dependency_table)
...
def test_check_access_without_rerouting_failed_source(graph_calcs_with_remote_node, dependency_table):
    """Test _check_access with rerouting enabled"""
    graph_calcs_with_remote_node.network_calc.network.initialize_funcstates()
    graph_calcs_with_remote_node.network_calc.network.initialize_capacity(dependency_table)
    graph_calcs_with_remote_node.network_calc.network.initialize_supply(dependency_table)
