...
Based on https://www.retssa-ci.com/pages/Numero5/ADAYE/6-Tome-1.Retssa-Vol.3-N%C2%B05-Juin%202020.pdf :
"The first excerpt (p. 2) states: "The pH of cassava is approximately 4, and minerals account for less than 1% of the ash content. The moisture content can exceed 50%. Cassava is an energy-dense food (over 300 Kcal/100g), but it is low in protein (1.1%) and fat (0.5%). The majority of its caloric value comes from carbohydrates (93% of the dry matter) and its high fiber content.
Furthermore, the FAO document "Produce More with Less" specifies that the dry matter content of cassava roots is about 30%, which means that one ton of fresh roots contains approximately 300 kilograms of dry matter (p. 14)."
